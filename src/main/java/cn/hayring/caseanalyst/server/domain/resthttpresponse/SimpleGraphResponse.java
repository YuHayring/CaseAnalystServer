...
public class SimpleGraphResponse {
    ...
    static class Node {
        ...
        public Node(cn.hayring.caseanalyst.server.domain.Node node) {
...
//            cn.hayring.caseanalyst.server.domain.Node start = relationship.getStart();
//            cn.hayring.caseanalyst.server.domain.Node end = relationship.getEnd();
